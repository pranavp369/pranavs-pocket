...
export default function BrainAgePredictionPart1() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen transition-colors duration-300 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 text-sky-100">
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="w-full max-w-4xl mx-auto space-y-8 sm:space-y-10 md:space-y-12 px-4 py-8">
        <section className="space-y-4 sm:space-y-6">
          <h2 className={`text-xl sm:text-2xl font-semibold flex items-center gap-2 px-2 sm:px-0 ${
            theme === "dark" ? "text-white" : "text-gray-800"
          }`}>
            <span className={theme === "dark" ? "text-green-400" : "text-orange-500"}>✨</span>
            Combined Example
          </h2>
